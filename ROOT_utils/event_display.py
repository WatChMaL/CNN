...
def get_args():
    parser = ArgumentParser(description='Display event at index from an input ROOT file')
    parser.add_argument('input_file', type=str, nargs=1)
    parser.add_argument('output_dir', type=str, nargs='?',default=None)
    parser.add_argument('index', type=int, nargs=1,default=0)
...
def event_display(config):
    ...
    fig101.savefig(config.output_dir+"pos_arc_z_disp_all_tubes.pdf")
    ...
    fig102.savefig(config.output_dir+"pos_x_y_disp_all_tubes.pdf")
    ...
    fig103.savefig(config.output_dir+"pos_arc_z_disp_wall_tubes.pdf")
    ...
    fig104.savefig(config.output_dir+"pos_arc_z_disp_wall_tubes_color_row.pdf")
    ...
    fig105.savefig(config.output_dir+"pos_arc_z_disp_wall_tubes_color_col.pdf")
    ...
    fig106.savefig(config.output_dir+"pos_x_y_disp_top_tubes.pdf")
    ...
    fig107.savefig(config.output_dir+"pos_x_y_disp_bottom_tubes.pdf")
    ...
    fig2.savefig(config.output_dir+"ev_disp_quiver_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig3.savefig(config.output_dir+"ev_disp_wall_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig4.savefig(config.output_dir+"ev_disp_top_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig5.savefig(config.output_dir+"ev_disp_bottom_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig6.savefig(config.output_dir+"q_sum_disp_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig7.savefig(config.output_dir+"q_max_disp_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig8.savefig(config.output_dir+"q_pmt_disp_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig9.savefig(config.output_dir+"t_pmt_disp_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig10.savefig(config.output_dir+"q_disp_grid_ev_{}_trig_{}.pdf".format(ev,index))
    ...
    fig11.savefig(config.output_dir+"t_disp_grid_ev_{}_trig_{}.pdf".format(ev,index))
