...
class WCH5DatasetTV(Dataset):
    ...
    def __init__(self, trainval_dset_path, trainval_idx_path, norm_params_path, chrg_norm="identity", time_norm="identity", shuffle=1, trainval_subset=None, seed=42):
