...
class Test_Dset:
    def __init__(self, tv_path, use_mem_map=False, use_tables=False, reopen_mem_map=False, driver=None, fadvise='file'):    
    ...
    def __getitem__(self, index):        
        ...
        if self.fadvise == 'file': os.posix_fadvise(self.fd.fileno(), 0, self.f.id.get_filesize(), os.POSIX_FADV_DONTNEED)
        elif self.fadvise == 'dataset': os.posix_fadvise(self.fd.fileno(), self.hdf5_event_data.id.get_offset(), self.hdf5_event_data.id.get_storage_size(), 
