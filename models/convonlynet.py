...
PyTorch implementation of the ConvOnlyNet as a classifier for input of size Batch_Size x Input_Channels x 16 x 40
...
class ConvNet(nn.Module):
    ...
    def __init__(self, num_input_channels=38, num_classes=3, train=True):
        ...
        self.en_max_conv1  = nn.Conv2d(64, 64, kernel_size=2, stride=2, padding=0)
        ...
        self.en_max_conv2  = nn.Conv2d(64, 64, kernel_size=2, stride=2, padding=0)
