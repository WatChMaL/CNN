...
class ConvtwovaeNet(nn.Module):
    ...
    def __init__(self, num_input_channels=19, num_latent_dims=64, num_classes=3, train=True):
        ...
        self.en_fc1 = nn.Linear(2048, 2048)
        self.en_fc22 = nn.Linear(2048, 2048)
        self.en_fc2 = nn.Linear(2048, 2048)
        ...
        self.en_fc41 = nn.Linear(2048, num_latent_dims)
        self.en_fc42 = nn.Linear(2048, num_latent_dims)
        ...
        # Fully connected layers
        self.de_fc4 = nn.Linear(num_latent_dims, 2048)
        #self.de_fc3 = nn.Linear(128, 256)
        self.de_fc2 = nn.Linear(2048, 2048)
        self.de_fc22 = nn.Linear(2048, 2048)
        self.de_fc1 = nn.Linear(2048, 2048)
    ...
    def encode(self, X):
        ...
        #----------------------------
        # Testing higher latent dims
        #----------------------------
        x = self.relu(self.en_fc22(x))
        #-----------------------------
        # End of testing code
        #-----------------------------
