...
# VaeNet class
class Vae3Net(nn.Module):
    
    # Initializer for the ConvNetVAE model
    def __init__(self, num_input_channels=19, num_latent_dimensions=32, train=True):
        
        # Initialize the superclass
        super(Vae3Net, self).__init__()
        ...
        self.de_fc4   = nn.Linear(16384, 12160)
