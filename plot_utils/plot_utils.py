...
def plot_ROC_curve_one_vs_one(softmaxes, labels, energies, softmax_index_dict, min_energy=0,
    ...
    # Extract the labels from the dict
    label_0 = list(softmax_index_dict.keys())[0]
    label_1 = list(softmax_index_dict.keys())[1]
